...
## :tada:  Examples  
  ```JavaScript
   ...
   rando(["a", "b", "c"])        //{index:..., value:...} object representing a value of the provided array OR false if array is empty  
...
### &#8674; Prevent repetitions by grabbing a sequence and looping through it  
  ```JavaScript
   ...
   randoSequence($("div"))       //an array of {index:..., value:...} objects representing a jQuery elements from the provided jQuery element set in random order  
