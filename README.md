...
## :tada:  Examples  
  ```JavaScript
   ...
   rando($("div"))               //{index:..., value:...} object representing a jQuery element from the provided jQuery element set OR false if the provided jQuery element set does not contain any elements. NOTE: currently not compatible with Node.js.  
...
### &#8674; Prevent repetitions by grabbing a sequence and looping through it  
  ```JavaScript
   ...
   randoSequence($("div"))       //an array of {index:..., value:...} objects representing all jQuery elements from the provided jQuery element set in random order. NOTE: currently not compatible with Node.js.  
