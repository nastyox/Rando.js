console.log("\nNOTE: This test sources in Rando.js using Node.js' standard \"require\" function, which is likely the same approach you will use for your project. If you plan to use an \"import\" statement rather than a call the standard \"require\" function, execute this command for testing instead:\nnode versions/import-compatible/test.mjs\n\nTEST RESULTS:");
...
try{
	var randojs = require('@nastyox/rando.js'), rando = randojs.rando, randoSequence = randojs.randoSequence;
	passed++;
