    ...
    var isUndefined = (variable) => typeof variable === "undefined",
        ...
        cryptoRandom = () => {
            try {
                ...
                (window.crypto || window.msCrypto).getRandomValues(randomUint32);
                return randomUint32[0] / (0xFFFFFFFF + 1); // 0xFFFFFFFF = uint32 limit, adding 1 to mimic Math.random behaviour (inclusive of 0 but not 1)
            } catch (e) {
                return Math.random();
            }
        };
